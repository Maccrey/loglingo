...
- **AI 말하기 연습**: 문장 단위 말하기 녹음 및 STT 텍스트 변환, AI 기반 발음·문법·표현 피드백 및 아카이브 자동 저장
  - **자유 대화 모드**: 원하는 주제로 자유롭게 말하기
  - **자유 대화 모드**: 원하는 주제로 자유롭게 말하기
  - **도전 모드 (Challenge Mode)**: 학습 아카이브의 약점(자주 틀린 단어) 기반으로 생성된 예문 따라 말하기 연습
  - **일일 제한 & AI 프롬프트**: 비용 제어를 위한 하루 3회 제한 및 외부 AI(Grok 등) 활용을 위한 **개인화된 맞춤형 토픽 프롬프트** 생성 제공
- **체험 모드 (Trial Mode)**: 로그인 없이 AI 교정을 경험해볼 수 있는 기능 (브라우저당 1회 제공, 데이터 저장 불가)
- **다국어 블로그**: 언어 학습 팁과 노하우를 공유하는 콘텐츠 섹션 (AdSense 콘텐츠 보강용, SEO 최적화)
- **습관 형성을 위한 Retention 기능 (버전업데이트)**:
  - 홈 화면 1문장 즉시 체험 및 원어민 TTS 경험으로 쉬운 진입점(Aha Moment) 제공
  - 연속 작성일수(스트릭🔥)를 통한 넛지와 동기 부여
  - 매일 새로운 '오늘의 질문(Daily Prompt)' 제공으로 첫 문장 작성의 막막함 해소
  - AI 교정 시 단순 문법 지적을 넘어 일기 내용에 공감하는 '다정한 감성 피드백' 및 리스닝 기능 제공
