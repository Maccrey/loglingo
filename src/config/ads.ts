...
export const AD_UNITS = {
  ...
  DIARY_INFEED_MOBILE: 'DAN-nMMQxJYfbvs9ho23',  // 320x50
  DIARY_BOTTOM_MOBILE: 'DAN-J5bc0QZrXNVRIkdg', // 320x50
  
  // 일기 상세 페이지
  DETAIL_MIDDLE_PC: 'DAN-9pyBe00OjbdGtJAK',    // 728x90
  DETAIL_MIDDLE_MOBILE: 'DAN-TByebZiEpxD0u97l',// 320x50
  ...
  ARCHIVE_TOP_MOBILE: 'DAN-pkC5Xz2lxipxYrJh',   // 320x50
  ARCHIVE_QUIZ_SIDE: 'DAN-w6FoEQSsAFNsj8ry',    // 250x250 (PC)
  ARCHIVE_QUIZ_MOBILE: 'DAN-uv5V9q4jsG4HyzWV',  // 320x50 (모바일)
