...
// ==========================================
// Post 2: Introverts vs. Extroverts
// ==========================================
...
<article>
  ...
  <hr />
  <h2>FAQ: Introvert Edition</h2>
  <h3>Q: How can I practice speaking if I'm too shy to talk to people?</h3>
  <p><strong>A:</strong> You don't need people. Use <strong>Shadowing</strong>. Talk to yourself in the shower. Record your voice and compare it to a native speaker. The best practice happens alone.</p>

  <h3>Q: Don't I need to "Speak from Day 1"?</h3>
  <p><strong>A:</strong> Not necessarily. "Input Hypothesis" suggests you should listen until you are ready. Speaking early is good for confidence, but listening first is good for accuracy. Do what fits your personality.</p>
</article>
`;
...
<article>
  ...
  <h3>외향인: 불꽃</h3>
  <ul>
    <li><strong>슈퍼파워:</strong> 사회적 위험 감수. 바보처럼 보이는 걸 두려워하지 않습니다.</li>
    <li><strong>약점:</strong> 덜 듣고 더 많이 말합니다. 정확성보다 속도를 중시해서 나쁜 습관이 굳어지기 쉽습니다.</li>
  </ul>

  <h3>내향인: 엔진</h3>
  <ul>
    <li><strong>슈퍼파워:</strong> 깊은 관찰력. 집중해서 듣고 패턴을 발견합니다.</li>
    <li><strong>약점:</strong> 분석 마비. 완벽해질 때까지 말하기를 두려워합니다.</li>
  </ul>

  <h2>전략</h2>
  <p>내향인이라면: <strong>대량 입력(Massive Input)</strong>에 집중하세요. 책을 읽고 영화를 보세요. 수동적 어휘의 거대한 저수지를 만드세요.</p>
  <p>외향인이라면: <strong>듣기</strong>를 강제하세요. 대화를 지배하려 하지 말고 질문을 하세요.</p>

  <hr />
  <h2>FAQ: 내향인을 위한 질문</h2>
  <h3>Q: 부끄러워서 사람과 말하기 힘든데 어떻게 연습하나요?</h3>
  <p><strong>A:</strong> 사람은 필요 없습니다. <strong>쉐도잉</strong>을 하세요. 혼잣말을 하세요. 당신의 목소리를 녹음해서 원어민과 비교하세요. 최고의 연습은 혼자 있을 때 일어납니다.</p>

  <h3>Q: "첫날부터 말하라"는 조언은요?</h3>
  <p><strong>A:</strong> 필수는 아닙니다. 준비될 때까지 듣는 것도 훌륭한 전략입니다. 일찍 말하기는 자신감에 좋지만, 먼저 듣기는 정확성에 좋습니다. 성향에 맞게 하세요.</p>
</article>
`;

const POST_INTROVERTS_JA = `<article><p>内向的な人は観察力があるので、初期段階では有利です。外向的な人は早口ですが間違いが多いです。<hr /><h3>FAQ</h3><p><strong>Q: 人と話すのが苦手です。</strong><br>A: 独り言やシャドーイングが最強の練習法です。相手は不要です。</p></article>`;
const POST_INTROVERTS_ZH = `<article><p>内向者擅长观察和倾听，这在初期是巨大的优势。<hr /><h3>FAQ</h3><p><strong>Q: 害羞怎么练习口语？</strong><br>A: 跟读 (Shadowing) 和自言自语。最好的练习往往是独自完成的。</p></article>`;
const POST_INTROVERTS_ES = `<article><p>Los introvertidos son mejores observadores. Estrategia: Entrada Masiva.<hr /><h3>FAQ</h3><p><strong>Q: ¿Cómo practico si soy tímido?</strong><br>A: Shadowing. Habla solo. No necesitas gente para practicar.</p></article>`;
const POST_INTROVERTS_FR = `<article><p>Les introvertis observent mieux. Stratégie : Immersion massive.<hr /><h3>FAQ</h3><p><strong>Q: Comment pratiquer si je suis timide ?</strong><br>A: Shadowing. Parlez seul. Vous n'avez pas besoin de gens pour progresser.</p></article>`;
const POST_INTROVERTS_DE = `<article><p>Introvertierte beobachten besser. Strategie: Massiver Input.<hr /><h3>FAQ</h3><p><strong>Q: Wie übe ich als schüchterner Mensch?</strong><br>A: Selbstgespräche und Shadowing. Du brauchst keine Partner.</p></article>`;
const POST_INTROVERTS_RU = `<article><p>Интроверты — лучшие наблюдатели. Стратегия: Массовый ввод.<hr /><h3>FAQ</h3><p><strong>Q: Как практиковаться, если я стесняюсь?</strong><br>A: Шедоуинг. Говорите сами с собой. Партнеры не нужны.</p></article>`;
const POST_INTROVERTS_PT = `<article><p>Introvertidos observam melhor. Estratégia: Input Massivo.<hr /><h3>FAQ</h3><p><strong>Q: Como praticar sendo tímido?</strong><br>A: Shadowing. Fale sozinho.</p></article>`;
const POST_INTROVERTS_TR = `<article><p>İçe dönükler daha iyi gözlemler. Strateji: Kapsamlı Girdi.<hr /><h3>FAQ</h3><p><strong>Q: Utangaçsam nasıl pratik yaparım?</strong><br>A: Kendi kendine konuş ve Gölgeleme yap.</p></article>`;
const POST_INTROVERTS_AR = `<article><p>الانطوائيون يلاحظون بشكل أفضل. الاستراتيجية: المدخلات الضخمة.<hr /><h3>FAQ</h3><p><strong>س: كيف أتدرب إذا كنت خجولاً؟</strong><br>ج: التحدث مع النفس والترديد.</p></article>`;
const POST_INTROVERTS_HI = `<article><p>अंतर्मुखी बेहतर निरीक्षण करते हैं। रणनीति: व्यापक इनपुट.<hr /><h3>FAQ</h3><p><strong>प्र: अगर मैं शर्मीला हूँ तो अभ्यास कैसे करूँ?</strong><br>उ: शैडोइंग। खुद से बात करें।</p></article>`;
const POST_INTROVERTS_BN = `<article><p>অন্তর্মুখীরা ভালো পর্যবেক্ষণ করে। কৌশল: বিশাল ইনপুট।<hr /><h3>FAQ</h3><p><strong>প্র: আমি লাজুক হলে কিভাবে অভ্যাস করব?</strong><br>উ: শ্যাডোইং। নিজের সাথে কথা বলুন।</p></article>`;
const POST_INTROVERTS_UR = `<article><p>تعارف پسند بہتر مشاہدہ کرتے ہیں۔ حکمت عملی: بڑے پیمانے پر ان پٹ۔<hr /><h3>FAQ</h3><p><strong>سوال: اگر میں شرمیلا ہوں تو مشق کیسے کروں؟</strong><br>جواب: شیڈونگ۔ اپنے آپ سے بات کریں۔</p></article>`;
const POST_INTROVERTS_NE = `<article><p>अन्तर्मुखीहरू राम्रो अवलोकन गर्छन्। रणनीति: विशाल इनपुट।<hr /><h3>FAQ</h3><p><strong>प्र: यदि म लजालु छु भने कसरी अभ्यास गर्ने?</strong><br>उ: छायाँ (Shadowing)। आफैसँग कुरा गर्नुहोस्।</p></article>`;
const POST_INTROVERTS_TH = `<article><p>คนเก็บตัวสังเกตได้ดีกว่า กลยุทธ์: Massive Input<hr /><h3>FAQ</h3><p><strong>Q: ถ้าขี้อายจะฝึกยังไง?</strong><br>A: พูดคนเดียวและทำ Shadowing ไม่จำเป็นต้องมีคู่ฝึก</p></article>`;
const POST_INTROVERTS_VI = `<article><p>Người hướng nội quan sát tốt hơn. Chiến lược: Đầu vào ồ ạt.<hr /><h3>FAQ</h3><p><strong>H: Làm sao để luyện tập nếu tôi nhút nhát?</strong><br>Đ: Shadowing. Tự nói chuyện một mình.</p></article>`;
const POST_INTROVERTS_ID = `<article><p>Introvert mengamati lebih baik. Strategi: Input Masif.<hr /><h3>FAQ</h3><p><strong>T: Bagaimana berlatih jika saya pemalu?</strong><br>J: Shadowing. Bicara sendiri.</p></article>`;
...
export const BLOG_POSTS_PART_8: BlogPost[] = [
  ...
  },
  {
    ...
    title: {
      en: "Introverts vs. Extroverts: Who Learns Faster?",
      ko: "내향인 vs 외향인: 누가 언어를 더 빨리 배울까?",
      ja: "内向的 vs 外向的：どちらが早く言語を習得するか？",
      zh: "内向 vs 外向：谁学语言更快？",
      es: "Introvertidos vs. Extrovertidos: ¿Quién Aprende Más Rápido?",
      fr: "Introvertis vs Extrovertis : Qui Apprend Plus Vite ?",
      de: "Introvertierte vs. Extrovertierte: Wer lernt schneller?",
      ru: "Интроверты против Экстравертов: Кто Учит Быстрее?",
      pt: "Introvertidos vs. Extrovertidos: Quem Aprende Mais Rápido?",
      tr: "İçe Dönükler vs Dışa Dönükler: Kim Daha Hızlı Öğrenir?",
      ar: "الانطوائيون مقابل المنفتحين: من يتعلم أسرع؟",
      hi: "अंतर्मुखी बनाम बहिर्मुखी: कौन तेजी से सीखता है?",
      bn: "অন্তর্মুখী বনাম বহির্মুখী: কে দ্রুত শেখে?",
      ur: "تعارف پسند بمقابلہ خارج پسند: کون تیزی سے سیکھता ہے؟",
      ne: "अन्तर्मुखी बनाम बहिर्मुखी: कसले छिटो सिक्छ?",
      th: "คนเก็บตัว vs คนเปิดเผย: ใครเรียนรู้เร็วกว่ากัน?",
      vi: "Hướng nội vs Hướng ngoại: Ai học nhanh hơn?",
      id: "Introvert vs Ekstrovert: Siapa yang Belajar Lebih Cepat?"
    },
    excerpt: {
      en: "The surprising truth about personality types in language learning. Introverts have a secret weapon that extroverts lack.",
      ko: "언어 학습과 성격 유형에 관한 놀라운 진실. 내향인에게는 외향인이 가지지 못한 비밀 무기가 있습니다.",
      ja: "言語学習における性格タイプの驚くべき真実。内向的な人には、外向的な人に欠けている秘密兵器があります。",
      zh: "关于语言学习中性格类型的惊人真相。内向者拥有外向者所缺乏的秘密武器。",
      es: "La sorprendente verdad sobre los tipos de personalidad. Los introvertidos tienen un arma secreta.",
      fr: "La vérité surprenante sur les types de personnalité. Les introvertis ont une arme secrète.",
      de: "Die überraschende Wahrheit über Persönlichkeitstypen. Introvertierte haben eine Geheimwaffe.",
      ru: "Удивительная правда о типах личности. У интровертов есть секретное оружие.",
      pt: "A verdade surpreendente sobre tipos de personalidade. Introvertidos têm uma arma secreta.",
      tr: "Kişilik tipleri hakkında şaşırtıcı gerçek. İçe dönüklerin gizli bir silahı vardır.",
      ar: "الحقيقة المفاجئة حول أنواع الشخصيات. الانطوائيون لديهم سلاح سري.",
      hi: "व्यक्तित्व के प्रकारों के बारे में आश्चर्यजनक सच। अंतर्मुखियों के पास एक गुप्त हथियार है।",
      bn: "ব্যক্তিত্বের ধরন সম্পর্কে আশ্চর্যজনক সত্য। অন্তর্মুখীদের একটি গোপন অস্ত্র আছে।",
      ur: "شخصیت کی اقسام کے بارے میں حیران کن سچائی۔ تعارف پسندوں کے پاس ایک خفیہ ہتھیار ہے۔",
      ne: "व्यक्तित्व प्रकारका बारेमा आश्चर्यजनक सत्य। अन्तर्मुखीहरूसँग गोप्य हतियार हुन्छ।",
      th: "ความจริงที่น่าประหลาดใจเกี่ยวกับประเภทบุคลิกภาพ คนเก็บตัวมีอาวุธลับ",
      vi: "Sự thật đáng ngạc nhiên về các loại tính cách. Người hướng nội có vũ khí bí mật.",
      id: "Kebenaran mengejutkan tentang tipe kepribadian. Introvert punya senjata rahasia."
    },
    content: {
    ...
    coverImage: "/assets/blog/introvert-extrovert.png",
    author: "Dr. Lingua",
    tags: ["Personality", "Strategy"],
    published: true,
