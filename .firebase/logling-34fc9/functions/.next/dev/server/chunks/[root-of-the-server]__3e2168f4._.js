...
"[project]/Development/Loglingo/src/app/api/observability/rum/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isRumMetric(value) {
    ...
    return allowed.includes(metric) && typeof value.value === "number" && typeof value.sessionId === "string";
}
async function POST(req) {
    const body = await req.json().catch(()=>null);
    const metric = body?.payload ?? body;
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Development$2f$Loglingo$2f$src$2f$infrastructure$2f$observability$2f$server$2d$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["persistRumMetric"])(metric);
    return __TURBOPACK__imported__module__$5b$project$5d2f$Development$2f$Loglingo$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true
    }, {
        status: 200,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3e2168f4._.js.map